...
exports.stringFunctions = [
    ...
    {
        name: "Atn",
        documentation: "A trigonometric function that calculates the arctangent of the numeric expression in radians.",
        params: [
            {
                name: "<numeric expression>",
            },
    ...
    {
        name: "Bell",
        documentation: "Returns a character which, when printed, sounds the printer's or terminal's bell. It is used mainly in PRINT statements.",
        params: [],
    },
    {
        name: "Ceil",
        documentation: "Calculates the smallest integer greater than or equal to X.",
        params: [
            {
                name: "<numeric expression>",
            },
    ...
    {
        name: "CmdKey",
        documentation: "Returns a value to identify the last command key (function key) used to terminate keyboard input, or returns 0 if <ENTER> was the last key pressed.",
        params: [],
    },
    {
        name: "Cnt",
        documentation: "Returns the number of data items successfully processed by the last I/O statement.",
        params: [],
    },
    {
        name: "Cod",
        documentation: "Indicates the termination status of a program as set by the STOP or END statement.",
        params: [],
    },
    {
        name: "CoS",
        documentation: "Trigonometric function that calculates the cosine of X in radians.",
        params: [
            {
                name: "<numeric expression>",
            },
    ...
    {
        name: "CurCol",
        documentation: "Returns cursor column from the last INPUT FIELDS or RINPUT FIELDS statement.",
        params: [],
    },
    {
        name: "CurFld",
        documentation: "Returns the number of the field containing the cursor from the last INPUT FIELDS.",
        params: [],
    },
    {
        name: "CurRow",
        documentation: "Returns the cursor's row from last Input Fields or RInput Fields statement.",
        params: [],
    },
    {
        name: "CurTab",
    ...
    {
        name: "Date",
        documentation: "Calculates and returns dates in numeric format, using no dashes or slashes as separators.",
        params: [
            {
                name: "[<Integer>]",
            },
    ...
    {
        name: "Days",
        documentation: "Returns the absolute, sequential value which is assigned to dates after January 1, 1900.",
        params: [
            {
                name: "<date>",
            },
    ...
    {
        name: "Debug_Str",
        documentation: "Depending on loglevel (message-level must be equal or lower), send data to the logfile as well as to the debugger if it is attached, or optionally to the command console if the debugger is not attached and GUI is ON.",
        params: [
            {
                name: "<message-level>",
            },
    ...
    {
        name: "Didx",
        documentation: " returns an array that is a descending index obtained from sorting the array named.",
        params: [
            {
                name: "<array name>",
            },
    ...
    {
        name: "Filenum",
        documentation: "returns the number of the file that produced the most recent I/O error.",
        params: [],
    },
    {
        name: "Fkey",
        documentation: "Similar to CmdKey, but returns more information, particularly about how a field is exited.",
        params: [
            {
                name: "<value>",
            },
    ...
    {
        name: "Freesp",
        documentation: "Returns the number of free (unused) bytes on the drive containing file N.",
        params: [
            {
                name: "<file name>",
            },
    ...
    {
        name: "Inf",
        documentation: "Returns the largest possible number in Business Rules! on the current system.",
        params: [],
    },
    {
        name: "Int",
    ...
    {
        name: "KLN",
        documentation: "Returns the key length in bytes for master file specified by 'file name'.",
        params: [
            {
                name: "<file name>",
            },
    ...
    {
        name: "Kps",
        documentation: "Returns the byte position where the key for master file named starts. With an optional second parameter, KPS can also return the position of a section of a key when split keys are used.",
        params: [
            {
                name: "<file name>",
            },
    ...
    {
        name: "KRec",
        documentation: "When file N is a display file, KRec(N) acts as a line counter for lines output to the file. If file N is an internal file opened for Keyed processing, then KRec(N) returns the number of the last record accessed in the key file.",
        params: [
            {
                name: "N",
            },
    ...
    {
        name: "Len",
        documentation: "The Len(string$) internal function returns the number of characters in variable string$.",
        params: [
            {
                name: "<string>",
            },
    ...
    {
        name: "Lines",
        documentation: "Returns the number of lines printed since the last new page.",
        params: [
            {
                name: "<file number>",
            },
    ...
    {
        name: "LineSPP",
        documentation: "Returns the current lines per page as set by a BRConfig.sys PRINTER spec's LPP parameter or 66 by default.",
        params: [
            {
                name: "<file number>",
            },
    ...
    {
        name: "Mat2Str",
        documentation: "Mat2Str internal function which converts an array to a string",
        params: [
            {
                name: "MAT <Array Name>",
            },
    ...
    {
        name: "Max",
        documentation: "Returns the largest numeric value in the set of numbers inside parentheses (X1, X2 and so on).",
        params: [
            {
                name: "<value>",
            },
    ...
    {
        name: "Min",
        documentation: "The Min internal function returns the smallest numeric value in the set of numbers inside parentheses (X1, X2 and so on). ",
        params: [
            {
                name: "<value>",
            },
    ...
    {
        name: "Mod",
        documentation: "The Mod internal function returns the remainder of the numerator divided by the denominator. In other words, it is the remainder left after the division of one integer by another ",
        params: [
            {
                name: "<numerator>",
            },
    ...
    {
        name: "Msg",
        documentation: "The MSG internal function (without the dollar sign) is only available for Windows & CS versions. This should not be confused with Msg$.",
        params: [
            {
                name: '"KB"',
            },
    ...
    {
        name: "Msgbox",
        documentation: "The MsgBox Internal Function will display a Windows Message Box. It has four possible parameters.",
        params: [
            {
                name: "PROMPT$",
            },
    ...
    {
        name: "Newpage",
        documentation: "The NewPage internal function returns a character which, when printed, causes the printer to do a form feed or the screen to clear.",
        params: [],
    },
    {
        name: "Ord",
        documentation: "ASCII ordinate value (from 0 to 255) of the first character in the string$.",
        params: [
            {
                name: "<string>",
            },
    ...
    {
        name: "Pos",
        documentation: "Returns the position of the first character of a substring in str1$ that matches str2$.",
        params: [
            {
                name: "<string>",
            },
    ...
    {
        name: "ProcIn",
        documentation: "Returns 0 if input is from the screen. Returns 1 if input is from a procedure file.",
        params: [],
    },
    {
        name: "Rec",
    ...
    {
        name: "Rem",
        documentation: "Returns the remainder of the numerator divided by the denominator.",
        "params": [
            {
                name: '<numerator>'
            },
    ...
    {
        name: "Round",
        documentation: "Calculates the value of the first value rounded to the specified number of decimal places. ",
        "params": [
            {
                name: '<numeric expression>'
            },
    ...
    {
        name: "Serial",
        documentation: "returns the serial number assigned to this copy of Business Rules!. ",
        params: [],
    },
    {
        name: "SetEnv",
        documentation: "Sets session based environmental variables in Business Rules!.",
        "params": [
            {
                name: '<field>'
            },
    ...
    {
        name: "Sgn",
        documentation: "Returns a value which identifies whether a numeric value is negative, positive or zero.",
        "params": [
            {
                name: '<X>'
            }
    ...
    {
        name: "Sin",
        documentation: "Trigonometric function that returns the sine of X in radians.",
        params: [
            {
                name: "<number>",
            },
    ...
    {
        name: "Sleep",
        documentation: "The Sleep internal function causes the processor to wait the specified number of seconds before continuing execution. It does not tie up the processor while waiting, which is especially important for multi-user systems.",
        params: [
            {
                name: "<seconds>",
            },
    ...
    {
        name: "Sum",
        documentation: "The Sum internal function returns the sum of all the elements in the numeric array named.\nSUM also works with multi-dimensional matrices.",
        params: [
            {
                name: "<numeric array>",
            },
    ...
    {
        name: "Tan",
        documentation: "The Tan internal function is a mathematical trigonometric function that calculates the tangent of X in radians. ",
        params: [
            {
                name: "<x>",
            },
    ...
    {
        name: "Timer",
        documentation: 'The Timer internal function returns a "Real Number" with 5 decimal digits accuracy with the number of seconds elapsed since midnight, January 1, 1970.\nThis starting point is obtained from the operating system so it is only as accurate as your system time.\nThis value is used internally by the pro filer to monitor performance, but may be used within programs to measure the time very accurately',
        params: [],
    },
    {
        name: "UDim",
        documentation: "The UDim(A$,X) internal function returns the number of rows in the array if X=1. Returns the number of columns in the array if X=2. Returns the current size of dimensions 3, 4, 5, 6 or 7 when X is 3, 4, 5, 6 or 7. If the optional parameter X is omitted, UDIM returns the size of the first dimension.",
        params: [
            {
                name: "<array name>",
            },
    ...
    {
        name: "VAL",
        documentation: "The Val(A$) internal function returns A$ expressed as a numeric value rather than a string.",
        params: [
            {
                name: "<string>",
            },
    ...
    {
        name: "Version",
        documentation: "The Version internal function affects an open internal data file.\nIt will return the version of that file. It can also be used to set the version.",
        params: [
            {
                name: "<file_handle>",
            },
